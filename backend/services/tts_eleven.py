...
ELEVEN_VOICE_ID = os.getenv("ELEVEN_VOICE_ID", "NBqeXKdZHweef6y0B67V")  # Default voice
...
async def tts(text: str, emotion: str = "neutral") -> bytes:
    ...
    model_id = "eleven_multilingual_v2"  # ← switch to multilingual
    ...
    async with httpx.AsyncClient(timeout=60) as client:
        r = await client.post(f"https://api.elevenlabs.io/v1/text-to-speech/{voice}/stream",
